...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/admin/dashboard') || pathname.startsWith('/admin/projects') || pathname.startsWith('/admin/users')) {
  ...
  if (pathname.startsWith('/faculty/dashboard') || pathname.startsWith('/faculty/projects') || pathname.startsWith('/faculty/guidance')) {
    const token = request.cookies.get('auth-token')?.value
