      ...
      <header className="nfsu-header-bg text-white">
        <div className="border-b border-white/10 px-6 py-2">
          <div className="max-w-4xl mx-auto flex justify-between text-xs text-white/60">
            <Link href="/faculty/dashboard" className="hover:text-white">← Dashboard</Link>
            <Link href="/" className="hover:text-white">NFSU Projects DB</Link>
          </div>
        </div>
        <div className="max-w-4xl mx-auto px-6 py-5">
          ...
          <p className="text-white/65 text-sm mt-1">Fill in the details below to document a student project</p>
        </div>
        <div className="gold-line" />
      </header>
      <main className="max-w-4xl mx-auto px-6 py-6">
        <ProjectForm redirectTo="/faculty/dashboard" />
      </main>
    </div>
  )
}
